...
(function() {
  ...
  */
  async function sqlite3InitModule(moduleArg = {}) {
    ...
    ((_b = (_a = globalThis.process) == null ? void 0 : _a.versions) == null ? void 0 : _b.node) && ((_c = globalThis.process) == null ? void 0 : _c.type);
    (function(Module2) {
      const sIMS = globalThis.sqlite3InitModuleState || Object.assign(/* @__PURE__ */ Object.create(null), { debugModule: function() {
      ...
      Module2["instantiateWasm"] = (function callee(imports, onSuccess) {
        ...
        const sims = this;
        const uri = Module2.locateFile(sims.wasmFilename, "undefined" === typeof scriptDirectory ? "" : scriptDirectory);
    ...
    function findWasmBinary() {
      ...
      return new URL("" + new URL("sqlite3-BVKGSWc-.wasm", self.location.href).href, self.location.href).href;
    }
    ...
    var FS_stdin_getChar = () => {
      ...
      if (!FS_stdin_getChar_buffer.length) {
        var result = null;
        if ((_a2 = globalThis.window) == null ? void 0 : _a2.prompt) {
    ...
    var FS = {
        ...
        linkloop: for (var nlinks = 0; nlinks < 40; nlinks++) {
          ...
          for (var i = 0; i < parts.length; i++) {
            ...
            try {
              ...
              if ((e == null ? void 0 : e.errno) === 44 && islast && opts.noent_okay) return { path: current_path };
              throw e;
            }
      ...
      createDevice(parent, name, input, output) {
        ...
        FS.registerDevice(dev, {
          ...
          close(stream) {
            var _a3;
            if ((_a3 = output == null ? void 0 : output.buffer) == null ? void 0 : _a3.length) output(10);
          },
          read(stream, buffer, offset, length, pos) {
            var bytesRead = 0;
            for (var i = 0; i < length; i++) {
    ...
    var getEnvStrings = () => {
      ...
      if (!getEnvStrings.strings) {
        var env = {
          ...
          "PWD": "/",
          "HOME": "/home/web_user",
          "LANG": (((_a2 = globalThis.navigator) == null ? void 0 : _a2.language) ?? "C").replace("-", "_") + ".UTF-8",
          "_": getExecutableName()
        };
    ...
    function _fd_sync(fd) {
      ...
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
        return (_b2 = (_a2 = stream.stream_ops) == null ? void 0 : _a2.fsync) == null ? void 0 : _b2.call(_a2, stream);
      } catch (e) {
        if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
        return e.errno;
      }
    ...
    Module.runSQLite3PostLoadInit = async function(sqlite3InitScriptInfo, EmscriptenModule, sqlite3IsUnderTest) {
      ...
      globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
        ...
        if (sqlite3.__isUnderTest) {
          ...
          const iw = (_a2 = sqlite3.scriptInfo) == null ? void 0 : _a2.instantiateWasm;
          if (iw) {
      ...
      globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
        ...
        if (!target.exports) Object.defineProperty(target, "exports", {
          ...
          get: () => {
            var _a2;
            return (_a2 = target.instance) == null ? void 0 : _a2.exports;
          }
        });
        ...
        const finalThen = function(arg) {
          ...
          if (config.wasmUtilTarget) {
            ...
            if (!tgt.instance.exports.memory)
              tgt.memory = ((_b2 = (_a2 = config == null ? void 0 : config.imports) == null ? void 0 : _a2.env) == null ? void 0 : _b2.memory) || toss("Missing 'memory' object!");
      ...
      globalThis.Jaccwabyt = function StructBinderFactory(config) {
        ...
        const __allocStruct = function f(ctor, obj, xm) {
          ...
          if (xm) {
            checkPtr(xm);
            ownsPointer = !!(opt == null ? void 0 : opt.takeOwnership);
          } else {
            const nX = (opt == null ? void 0 : opt.extraBytes) ?? 0;
            if (nX < 0 || nX !== (nX | 0)) toss("Invalid extraBytes value:", opt == null ? void 0 : opt.extraBytes);
            nAlloc = ctor.structInfo.sizeof + nX;
            xm = alloc(nAlloc) || toss("Allocation of", ctor.structName, "structure failed.");
            ownsPointer = true;
          }
          try {
            if (opt == null ? void 0 : opt.debugFlags) obj.debugFlags(opt.debugFlags);
            ...
            ii.zod = !!(opt == null ? void 0 : opt.zeroOnDispose);
            if ((opt == null ? void 0 : opt.ondispose) && opt.ondispose !== xm) obj.addOnDispose(opt.ondispose);
          } catch (e) {
        ...
        StructType.prototype = Object.create(null, {
          ...
          extraBytes: {
            ...
            get: function() {
              var _a2;
              return ((_a2 = getInstanceHandle(this, false)) == null ? void 0 : _a2.xb) ?? 0;
            }
          },
          zeroOnDispose: {
            configurable: false,
            ...
            get: function() {
              var _a2;
              return ((_a2 = getInstanceHandle(this, false)) == null ? void 0 : _a2.zod) ?? !!this.structInfo.zeroOnDispose;
            }
          },
          pointer: {
            configurable: false,
            ...
            get: function() {
              var _a2;
              return (_a2 = getInstanceHandle(this, false)) == null ? void 0 : _a2.p;
            },
        ...
        Object.defineProperties(StructType, {
          ...
          hasExternalPointer: rop((v2) => {
            ...
            return !!((ii == null ? void 0 : ii.p) && !(ii == null ? void 0 : ii.ownsPointer));
          }),
          memberKey: __memberKeyProp
        });
        ...
        const StructBinderImpl = function StructBinderImpl2(structName, si, opt = /* @__PURE__ */ Object.create(null)) {
          ...
          if (!autoCalc) {
            ...
            si.offset ?? (si.offset = 0);
          } else si.offset ?? (si.offset = 0);
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        ...
        delete globalThis.Jaccwabyt;
        {
          ...
          wasm.xWrap.argAdapter("sqlite3_filename", __xArgPtr)("sqlite3_context*", __xArgPtr)("sqlite3_value*", __xArgPtr)("void*", __xArgPtr)("sqlite3_changegroup*", __xArgPtr)("sqlite3_changeset_iter*", __xArgPtr)("sqlite3_session*", __xArgPtr)("sqlite3_stmt*", (v2) => {
            var _a2;
            return __xArgPtr(v2 instanceof (((_a2 = sqlite3 == null ? void 0 : sqlite3.oo1) == null ? void 0 : _a2.Stmt) || nilType) ? v2.pointer : v2);
          })("sqlite3*", (v2) => {
            var _a2;
            return __xArgPtr(v2 instanceof (((_a2 = sqlite3 == null ? void 0 : sqlite3.oo1) == null ? void 0 : _a2.DB) || nilType) ? v2.pointer : v2);
          })("sqlite3_vfs*", (v2) => {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        ...
        const StructPtrMapper = function(name, StructType) {
          ...
          return Object.assign(/* @__PURE__ */ Object.create(null), {
            ...
            dispose: (pCObj) => {
              var _a2, _b2;
              return (_b2 = (_a2 = __xWrap(pCObj, true)) == null ? void 0 : _a2.dispose) == null ? void 0 : _b2.call(_a2);
            }
          });
        };
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        var _a2, _b2, _map, _keys, _size, _KVVfsStorage_instances, getKeys_fn, _c2;
        if ((_b2 = (_a2 = sqlite3.config.disable) == null ? void 0 : _a2.vfs) == null ? void 0 : _b2.kvvfs) return;
        ...
        cache.memBuffer = (id = 0) => {
          var _a3;
          return (_a3 = cache.buffer.pool)[id] ?? (_a3[id] = wasm.alloc(cache.buffer.n));
        };
        ...
        const debug = sqlite3.__isUnderTest ? (...args) => {
          var _a3, _b3;
          return (_b3 = (_a3 = sqlite3.config).debug) == null ? void 0 : _b3.call(_a3, "kvvfs:", ...args);
        } : noop;
        const warn = (...args) => {
          var _a3, _b3;
          return (_b3 = (_a3 = sqlite3.config).warn) == null ? void 0 : _b3.call(_a3, "kvvfs:", ...args);
        };
        const error = (...args) => {
          var _a3, _b3;
          return (_b3 = (_a3 = sqlite3.config).error) == null ? void 0 : _b3.call(_a3, "kvvfs:", ...args);
        };
        class KVVfsStorage {
          constructor() {
            __privateAdd(this, _KVVfsStorage_instances);
            __privateAdd(this, _map, /* @__PURE__ */ Object.create(null));
            __privateAdd(this, _keys, null);
            __privateAdd(this, _size, 0);
            this.clear();
          }
          key(n) {
            if (n < 0 || n >= __privateGet(this, _size)) return null;
            return __privateMethod(this, _KVVfsStorage_instances, getKeys_fn).call(this)[n];
          }
          getItem(k2) {
            return __privateGet(this, _map)[k2] ?? null;
          }
          setItem(k2, v2) {
            if (!(k2 in __privateGet(this, _map))) {
              ++__privateWrapper(this, _size)._;
              __privateSet(this, _keys, null);
            }
            __privateGet(this, _map)[k2] = "" + v2;
          }
          removeItem(k2) {
            if (k2 in __privateGet(this, _map)) {
              delete __privateGet(this, _map)[k2];
              --__privateWrapper(this, _size)._;
              __privateSet(this, _keys, null);
            }
          }
          clear() {
            __privateSet(this, _map, /* @__PURE__ */ Object.create(null));
            __privateSet(this, _keys, null);
        ...
        _keys = new WeakMap();
        _size = new WeakMap();
        _KVVfsStorage_instances = new WeakSet();
        getKeys_fn = function() {
          return __privateGet(this, _keys) ?? __privateSet(this, _keys, Object.keys(__privateGet(this, _map)));
        };
        ...
        const deleteStorage = function(store) {
          ...
          ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xClose) && debug("cleaning up storage handles [", store.jzClass, other, "]", store);
            ...
            for (const ear of store.listeners) {
              ...
              if (f) {
                ...
                if ("write" === eventName && ear.decodePages && +args[0] > 0) {
                  ev.data = [args[0]];
                  if (wcache == null ? void 0 : wcache[args[0]]) {
                  ...
                  if (rc > 0) {
                    wcache ?? (wcache = /* @__PURE__ */ Object.create(null));
                ...
                try {
                  (_b3 = (_a3 = f(ev)) == null ? void 0 : _a3.catch) == null ? void 0 : _b3.call(_a3, catchForNotify);
                } catch (e) {
          ...
          recordHandler: {
            xRcrdRead: (zClass, zKey, zBuf, nBuf) => {
              ...
              try {
                ...
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xRcrdRead) && warn("xRcrdRead", jzClass, jXKey, nBuf, store);
            ...
            xRcrdWrite: (zClass, zKey, zData) => {
              ...
              try {
                ...
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xRcrdWrite) && warn("xRcrdWrite", jxKey, store);
            ...
            xRcrdDelete: (zClass, zKey) => {
              ...
              try {
                const store = storageForZClass(zClass);
                const jxKey = jsKeyForStorage(store, zClass, zKey);
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xRcrdDelete) && warn("xRcrdDelete", jxKey, store);
          ...
          vfs: {
            xOpen: function(pProtoVfs, zName, pProtoFile, flags, pOutFlags) {
              ...
              try {
                ...
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xOpen) && debug("xOpen", jzClass, "flags =", flags);
                ...
                if (s) {
                  ...
                  ((_b3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _b3.xOpen) && debug("xOpen installed storage handle [", nm, nm + "-journal", "]", s);
                }
            ...
            xAccess: function(pProtoVfs, zPath, flags, pResOut) {
              ...
              try {
                ...
                const jzPath = (s == null ? void 0 : s.jzClass) || wasm.cstrToJs(zPath);
                if ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xAccess) debug("xAccess", jzPath, "flags =", flags, "*pResOut =", wasm.peek32(pResOut), "store =", s);
                if (!s)
                  try {
          ...
          ioDb: {
            xClose: function(pFile) {
              ...
              try {
                ...
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xClose) && debug("xClose", pFile, h);
                if (h) {
            ...
            xFileControl: function(pFile, opId, pArg) {
              ...
              try {
                ...
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xFileControl) && debug("xFileControl", h, "op =", opId);
                if (opId === capi.SQLITE_FCNTL_PRAGMA && kvvfsInternal.disablePageSizeChange) {
                  ...
                  if ("page_size" === wasm.cstrToJs(zName)) {
                    ((_b3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _b3.xFileControl) && debug("xFileControl pragma", wasm.cstrToJs(zName));
                    const zVal = wasm.peekPtr(wasm.ptr.add(pArg, 2 * wasm.ptr.size));
                    if (zVal) {
                      ((_c3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _c3.xFileControl) && warn("xFileControl pragma", h, "NOT setting page size to", wasm.cstrToJs(zVal));
                      h.file.$szPage = -1;
                      return 0;
                    } else if (h.file.$szPage > 0) {
                      ((_d = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _d.xFileControl) && warn("xFileControl", h, "getting page size", h.file.$szPage);
            ...
            xSync: function(pFile, flags) {
              ...
              try {
                const h = pFileHandles.get(pFile);
                ((_a3 = kvvfs == null ? void 0 : kvvfs.log) == null ? void 0 : _a3.xSync) && debug("xSync", h);
                util.assert(h, "Missing KVVfsFile handle");
        ...
        const sqlite3_js_kvvfs_export = function callee(...args) {
          ...
          if (!store) toss3(capi.SQLITE_NOTFOUND, "There is no kvvfs storage named", opt == null ? void 0 : opt.name);
          const s = store.storage;
          ...
          for (; i < n; ++i) {
            ...
            if (!keyPrefix || k2.startsWith(keyPrefix)) {
              let kk = ((_a3 = keyPrefix ? rxTail.exec(k2) : void 0) == null ? void 0 : _a3[1]) ?? k2;
              switch (kk) {
                case "jrnl":
        ...
        const sqlite3_js_kvvfs_import = function(exp, overwrite = false) {
          if (!(exp == null ? void 0 : exp.timestamp) || !exp.name || void 0 === exp.size || !Array.isArray(exp.pages)) toss3(capi.SQLITE_MISUSE, "Malformed export object.");
        ...
        const sqlite3_js_kvvfs_listen = function(opt) {
          ...
          if (opt.events) (store.listeners ?? (store.listeners = [])).push(opt);
        };
        const sqlite3_js_kvvfs_unlisten = function(opt) {
          const store = storageForZClass(opt == null ? void 0 : opt.storage);
          if ((store == null ? void 0 : store.listeners) && opt.events) {
        ...
        if ((_c2 = sqlite3.oo1) == null ? void 0 : _c2.DB) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        var _a2, _b2;
        if (((_b2 = (_a2 = sqlite3.config.disable) == null ? void 0 : _a2.vfs) == null ? void 0 : _b2.opfs) && sqlite3.config.disable.vfs["opfs-vfs"]) return;
        ...
        opfsUtil.vfsInstallationFeatureCheck = function(vfsName) {
          ...
          else if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !((_b3 = (_a3 = globalThis.FileSystemFileHandle) == null ? void 0 : _a3.prototype) == null ? void 0 : _b3.createSyncAccessHandle) || !((_c2 = navigator == null ? void 0 : navigator.storage) == null ? void 0 : _c2.getDirectory)) toss("Missing required OPFS APIs.");
        ...
        opfsUtil.initOptions = function callee(vfsName, options) {
          ...
          options.verbose ?? (options.verbose = urlParams.has("opfs-verbose") ? +urlParams.get("opfs-verbose") : 1);
          ...
          if (!opfsUtil.proxyUri) {
            ...
            if ((_a3 = sqlite3.scriptInfo) == null ? void 0 : _a3.sqlite3Dir) opfsUtil.proxyUri = sqlite3.scriptInfo.sqlite3Dir + opfsUtil.proxyUri;
          }
          options.proxyUri ?? (options.proxyUri = opfsUtil.proxyUri);
        ...
        opfsUtil.createVfsState = function() {
          ...
          opfsVfs.metrics = util.nu({
            ...
            dump: function() {
              ...
              (_b3 = (_a3 = opfsVfs.worker) == null ? void 0 : _a3.postMessage) == null ? void 0 : _b3.call(_a3, { type: "opfs-async-metrics" });
            },
            reset: function() {
              let k2;
          ...
          opfsVfs.bindVfs = function(ioMethods, callback) {
            ...
            return new Promise(function(promiseResolve_, promiseReject_) {
              ...
              let proxyUri = options2.proxyUri + (options2.proxyUri.indexOf("?") < 0 ? "?" : "&") + "vfs=" + vfsName;
              const W = opfsVfs.worker = new Worker(new URL(proxyUri, self.location.href));
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        var _a2, _b2;
        if (!sqlite3.opfs || ((_b2 = (_a2 = sqlite3.config.disable) == null ? void 0 : _a2.vfs) == null ? void 0 : _b2.opfs)) return;
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        var _a2, _b2, _dhVfsRoot, _dhOpaque, _dhVfsParent, _mapSAHToName, _mapFilenameToSAH, _availableSAH, _mapS3FileToOFile_, _apBody, _dvBody, _cVfs, _verbosity, _OpfsSAHPool_instances, logImpl_fn, _p;
        if ((_b2 = (_a2 = sqlite3.config.disable) == null ? void 0 : _a2.vfs) == null ? void 0 : _b2["opfs-sahpool"]) return;
        const toss = sqlite3.util.toss;
        ...
        class OpfsSAHPool {
          constructor(options = /* @__PURE__ */ Object.create(null)) {
            ...
            __privateSet(this, _dvBody, new DataView(__privateGet(this, _apBody).buffer, __privateGet(this, _apBody).byteOffset));
          ...
          getFileNames() {
            const rc = [];
            for (const n of __privateGet(this, _mapFilenameToSAH).keys()) rc.push(n);
            return rc;
          }
          /**
          ...
          */
          async addCapacity(n) {
            for (let i = 0; i < n; ++i) {
              ...
              const ah = await (await __privateGet(this, _dhOpaque).getFileHandle(name, { create: true })).createSyncAccessHandle();
          ...
          */
          async acquireAccessHandles(clearFiles = false) {
            const files = [];
            for await (const [name, h] of __privateGet(this, _dhOpaque)) if ("file" === h.kind) files.push([name, h]);
            return Promise.all(files.map(async ([name, h]) => {
              try {
                ...
                if (clearFiles) {
                  ...
                  if (path) __privateGet(this, _mapFilenameToSAH).set(path, ah);
                  else __privateGet(this, _availableSAH).add(ah);
                }
              } catch (e) {
                this.storeErr(e);
          ...
          */
          getAssociatedPath(sah) {
            ...
            if (__privateGet(this, _apBody)[0] && (flags & capi.SQLITE_OPEN_DELETEONCLOSE || (flags & PERSISTENT_FILE_TYPES) === 0)) {
              warn(`Removing file with unexpected flags ${flags.toString(16)}`, __privateGet(this, _apBody));
              this.setAssociatedPath(sah, "", 0);
              return "";
            }
            const fileDigest = new Uint32Array(HEADER_DIGEST_SIZE / 4);
            sah.read(fileDigest, { at: HEADER_OFFSET_DIGEST });
            const compDigest = this.computeDigest(__privateGet(this, _apBody), flags);
          ...
          */
          setAssociatedPath(sah, path, flags) {
            ...
            const digest = this.computeDigest(__privateGet(this, _apBody), flags);
          ...
          */
          async reset(clearFiles) {
            ...
            __privateSet(this, _dhOpaque, await __privateGet(this, _dhVfsRoot).getDirectoryHandle(OPAQUE_DIR_NAME, { create: true }));
            this.releaseAccessHandles();
          ...
          */
          async removeVfs() {
            ...
            try {
              this.releaseAccessHandles();
              await __privateGet(this, _dhVfsRoot).removeEntry(OPAQUE_DIR_NAME, { recursive: true });
              __privateSet(this, _dhOpaque, void 0);
              await __privateGet(this, _dhVfsParent).removeEntry(__privateGet(this, _dhVfsRoot).name, { recursive: true });
          ...
          */
          pauseVfs() {
            if (__privateGet(this, _mapS3FileToOFile_).size > 0) sqlite3.SQLite3Error.toss(capi.SQLITE_MISUSE, "Cannot pause VFS", this.vfsName, "because it has opened files.");
            if (__privateGet(this, _mapSAHToName).size > 0) {
          ...
          */
          isPaused() {
            return 0 === __privateGet(this, _mapSAHToName).size;
          }
          /**
          ...
          */
          async unpauseVfs() {
            if (0 === __privateGet(this, _mapSAHToName).size) return this.acquireAccessHandles(false).then(() => capi.sqlite3_vfs_register(__privateGet(this, _cVfs), 0), this);
            return this;
          }
        ...
        logImpl_fn = function(level, ...args) {
          if (__privateGet(this, _verbosity) > level) loggers[level](this.vfsName + ":", ...args);
        };
        class OpfsSAHPoolUtil {
          ...
          pauseVfs() {
            __privateGet(this, _p).pauseVfs();
            return this;
          }
          async unpauseVfs() {
            return __privateGet(this, _p).unpauseVfs().then(() => this);
          }
          isPaused() {
            return __privateGet(this, _p).isPaused();
          }
        }
        _p = new WeakMap();
        const apiVersionCheck = async () => {
          ...
          if (close == null ? void 0 : close.then) toss("The local OPFS API is too old for opfs-sahpool:", "it has an async FileSystemSyncAccessHandle.close() method.");
          return true;
        };
        sqlite3.installOpfsSAHPoolVfs = async function(options = /* @__PURE__ */ Object.create(null)) {
          ...
          if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !globalThis.FileSystemFileHandle || !globalThis.FileSystemFileHandle.prototype.createSyncAccessHandle || !((_a3 = navigator == null ? void 0 : navigator.storage) == null ? void 0 : _a3.getDirectory)) return initPromises[vfsName] = Promise.reject(/* @__PURE__ */ new Error("Missing required OPFS APIs."));
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
        var _a2, _b2;
        if (!sqlite3.opfs || ((_b2 = (_a2 = sqlite3.config.disable) == null ? void 0 : _a2.vfs) == null ? void 0 : _b2["opfs-wl"])) return;
        const util = sqlite3.util;
        sqlite3.util.toss;
  ...
  sqlite3InitModule = function() {
    ...
    const sIM = globalThis.sqlite3InitModule = function ff(...args) {
      var _a2, _b2;
      sIMS.emscriptenLocateFile = (_a2 = args[0]) == null ? void 0 : _a2.locateFile;
      sIMS.emscriptenInstantiateWasm = (_b2 = args[0]) == null ? void 0 : _b2.instantiateWasm;
...
//# sourceMappingURL=sqlite3-worker1-MedZ8emi.js.map
